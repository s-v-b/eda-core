...
- Due : March 7, 2026
- Work in pairs
- Deliver your work as a `qmd` file through a github {{< fa brands github >}} repository  (your github repository should be organized and named accoring to the [rules]())
...
[OECD](https://data.oecd.org), [Eurostat]() offer detailed statistics at different territorial levels.
[Our World in Data](https://ourworldindata.org)
[World Bank](https://data.worldbank.org)


Using data gathered from [OECD](https://data.oecd.org), build  dataframes with a gapminder-like schema (territorial units/timestamps as  keys, statistics for other columns). Using `ggplot2` and `plotly`, design plots and  animations like the \[Rossling address to BBC\](). Display 
